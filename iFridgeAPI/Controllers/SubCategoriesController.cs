...
namespace iFridgeAPI.Controllers
{
    ...
    public class SubCategoriesController : ControllerBase
    {
        ...
        public SubCategoriesController(V2DataContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<IEnumerable<SubCategory>>> GetSubCategory(){
            ...
            //List<SubCategory> subCategories = await _context.SubCategory.Include("Category").ToListAsync();
            List<SubCategory> subCategories = await _context.SubCategory.Include(c=> c.Category).ToListAsync();
        ...
        public async Task<ActionResult<SubCategory>> GetSubCategory(int id)
        {
            ...
            subCategory.Category = categories.Find(c => c.CategoryId == subCategory.SubCategoryId);
